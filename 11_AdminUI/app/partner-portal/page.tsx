...
export default async function PartnersPage() {
  ...
  return (
    <PartnerPortal
      ...
      brandHostEyebrow={settings.brandHostEyebrow}
      brandHostTitle={settings.brandHostTitle}
      brandHostBody={settings.brandHostBody}
      brandHostUsageLabel={settings.brandHostUsageLabel}
      brandHostUsageValue={settings.brandHostUsageValue}
      brandHostContextLabel={settings.brandHostContextLabel}
      brandHostContextValue={settings.brandHostContextValue}
      brandOwnerEyebrow={settings.brandOwnerEyebrow}
      brandOwnerBody={settings.brandOwnerBody}
