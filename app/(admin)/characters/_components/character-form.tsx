...
const FormSchema = z.object({
  ...
  modes:           z.array(z.object({ label: z.string().min(1, "Label required"), when: z.string(), costume: z.string(), posture: z.string() })),
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-3xl space-y-5">
      ...
      <Section title="Appearance Modes" defaultOpen={false}>
        ...
        <Button type="button" variant="outline" size="sm" onClick={() => modes.append({ label: "", when: "", costume: "", posture: "" })}>
